...
function makeStyles(t) {
  ...
  return StyleSheet.create({
    ...
    hint: { fontFamily: fonts.ko, fontSize: 12.5, lineHeight: 19 },
    ...
    modalSub: { fontFamily: fonts.ko, fontSize: 13.5, lineHeight: 21, textAlign: 'center' },
    ...
    transKo: { fontFamily: fonts.ko, fontSize: 13, lineHeight: 21 },
    ...
    choiceBody: { flex: 1 },
    choiceText: { fontFamily: fonts.jp, fontSize: 15, lineHeight: 23 },
    ...
    explainText: { fontFamily: fonts.ko, fontSize: 13, lineHeight: 21 },
    ...
    retryNote: { fontFamily: fonts.ko, fontSize: 12.5, lineHeight: 19, marginTop: 6 },
    ...
    wordSheetNote: { fontFamily: fonts.ko, fontSize: 12, lineHeight: 18, marginBottom: 4 },
    wordEmpty: { fontFamily: fonts.ko, fontSize: 13, lineHeight: 20, paddingVertical: 14, textAlign: 'center' },

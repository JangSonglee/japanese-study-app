...
export default function QuizScreen({ nav, level = '', kind = 'reading', cards }) {
  ...
  function submit() {
    ...
    if (round === 1 && card.question?.id) {
      attemptsRef.current.push({ question_id: card.question.id, outcome: ok ? 'correct' : 'wrong', is_correct: ok });
    }
...
function makeStyles(t) {
  ...
  return StyleSheet.create({
    ...
    // 🔴 디자인 토큰 이관(2026-07-31): KO UI 텍스트는 typeStyle(role)로. 라벨 굵기·tabular는 뒤에 오버라이드.
    //   🔴 KEEP: speaker(Ruby 정렬)·choiceText·stemText(일본어 콘텐츠) — JP 리듬/정렬이라 스케일 강제 안 함.
    appTitle: { flex: 1, fontFamily: fonts.ko, ...typeStyle('bodySm'), fontWeight: '600' },
    kbd: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: radius.full },
    kbdText: { fontFamily: fonts.ko, ...typeStyle('label'), fontWeight: '600', fontVariant: ['tabular-nums'] },
    body: { padding: 16, gap: 12, minHeight: '100%' },
    ...
    areaHint: { fontFamily: fonts.ko, ...typeStyle('label') },
    card: { borderRadius: radius.lg, padding: 16, gap: 10 },
    lblLow: { fontFamily: fonts.ko, ...typeStyle('label') },
    audioBox: { borderRadius: radius.sm, borderWidth: 1, borderStyle: 'dashed', paddingVertical: 16, paddingHorizontal: 12, alignItems: 'center' },
    audioText: { fontFamily: fonts.ko, ...typeStyle('label') },
    ...
    audioTitle: { fontFamily: fonts.ko, ...typeStyle('bodySm'), fontWeight: '700' },
    audioSub: { fontFamily: fonts.ko, ...typeStyle('label') },
    progressRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    progressHit: { flex: 1, paddingVertical: 8, justifyContent: 'center' }, // 손가락 탭 여유
    ...
    timeText: { fontFamily: fonts.ko, ...typeStyle('caption'), fontWeight: '600', fontVariant: ['tabular-nums'], minWidth: 30, textAlign: 'center' },
    hint: { fontFamily: fonts.ko, ...typeStyle('label') },
    ...
    modalTitle: { fontFamily: fonts.ko, ...typeStyle('heading'), fontWeight: '800', marginTop: 4 },
    modalSub: { fontFamily: fonts.ko, ...typeStyle('bodySm'), textAlign: 'center' },
    ...
    modalPriText: { fontFamily: fonts.ko, ...typeStyle('bodySm'), fontWeight: '700' },
    ...
    modalGhostText: { fontFamily: fonts.ko, ...typeStyle('bodySm'), fontWeight: '600' },
    toggleRow: { flexDirection: 'row', gap: 8, marginTop: 6 },
    sentence: { gap: 2 },
    line: { flexDirection: 'row', gap: 8 },
    speaker: { fontFamily: fonts.ko, fontSize: 15, fontWeight: '700', width: 18, paddingTop: rTop17, lineHeight: bodyLH17 }, // KEEP: Ruby base 정렬
    lineBody: { flex: 1, gap: 2 },
    transKo: { fontFamily: fonts.ko, ...typeStyle('bodySm') },
    choices: { gap: 8, marginTop: 4 },
    choice: { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: radius.sm, borderWidth: 1.5, paddingHorizontal: 12, paddingVertical: 12 },
    numBadge: { width: 24, height: 24, borderRadius: radius.full, alignItems: 'center', justifyContent: 'center' },
    numBadgeText: { fontFamily: fonts.ko, ...typeStyle('label'), fontWeight: '700', fontVariant: ['tabular-nums'] },
    choiceBody: { flex: 1 },
    choiceText: { fontFamily: fonts.jp, fontSize: 15, lineHeight: 23 }, // KEEP: 일본어 콘텐츠(선택지)
    stemText: { fontFamily: fonts.jp, fontSize: 16, fontWeight: '700', lineHeight: 26 }, // KEEP: 일본어 콘텐츠(문제)
    mark: { fontFamily: fonts.ko, ...typeStyle('label'), fontWeight: '700' },
    explain: { borderRadius: radius.sm, padding: 12, gap: 4 },
    explainText: { fontFamily: fonts.ko, ...typeStyle('bodySm') },
    ...
    retryNote: { fontFamily: fonts.ko, ...typeStyle('label'), marginTop: 6 },
    note: { fontFamily: fonts.ko, ...typeStyle('bodySm'), padding: 12 },
    ...
    wordChipLabel: { fontFamily: fonts.ko, ...typeStyle('label'), fontWeight: '600' },
    wordChipCount: { fontFamily: fonts.ko, ...typeStyle('bodySm'), fontWeight: '700', flex: 1 },
    wordChipCta: { flexDirection: 'row', alignItems: 'center', gap: 2 },
    wordChipCtaText: { fontFamily: fonts.ko, ...typeStyle('label'), fontWeight: '600' },
    wordSheet: { paddingHorizontal: 12, paddingBottom: 12 },
    wordSheetNote: { fontFamily: fonts.ko, ...typeStyle('label'), marginBottom: 4 },
    wordEmpty: { fontFamily: fonts.ko, ...typeStyle('bodySm'), paddingVertical: 16, textAlign: 'center' },
    ...
    wordLevelText: { fontFamily: fonts.ko, ...typeStyle('label'), fontWeight: '700', fontVariant: ['tabular-nums'] },
    wordRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, borderBottomWidth: 1 },
    wordJa: { width: 96 },
    wordMeaning: { flex: 1, fontFamily: fonts.ko, ...typeStyle('bodySm') },
  });
}
